...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    <meta charset="utf-8" />
    <title>Materialized View Dialog &#8212; pgAdmin 4 4.11 documentation</title>
...
<p>Use the <em>Materialized View</em> dialog to define a materialized view. A materialized
...
view.</p>
<p>The <em>Materialized View</em> dialog organizes the development of a materialized_view
through the following dialog tabs: <em>General</em>, <em>Definition</em>, <em>Storage</em>,
<em>Parameter</em>, and <em>Security</em>. The <em>SQL</em> tab displays the SQL code generated by
dialog selections.</p>
<img alt="Materialized view dialog general tab" class="align-center" src="_images/materialized_view_general.png" />
<p>Use the fields in the <em>General</em> tab to identify the materialized view:</p>
<ul class="simple">
<li><p>Use the <em>Name</em> field to add a descriptive name for the materialized view. The
name will be displayed in the <em>pgAdmin</em> tree control.</p></li>
<li><p>Use the drop-down listbox next to <em>Owner</em> to select the role that will own
the materialized view.</p></li>
<li><p>Select the name of the schema in which the materialized view will reside from
the drop-down listbox in the <em>Schema</em> field.</p></li>
<li><p>Store notes about the materialized view in the <em>Comment</em> field.</p></li>
</ul>
<p>Click the <em>Definition</em> tab to continue.</p>
<img alt="Materialized view dialog definition tab" class="align-center" src="_images/materialized_view_definition.png" />
<p>Use the text editor field in the <em>Definition</em> tab to provide the query that will
populate the materialized view.</p>
<p>Click the <em>Storage</em> tab to continue.</p>
<img alt="Materialized view dialog storage tab" class="align-center" src="_images/materialized_view_storage.png" />
<p>Use the fields in the <em>Storage</em> tab to maintain the materialized view:</p>
<ul class="simple">
<li><p>Move the <em>With Data</em> switch to the <em>Yes</em> position to specify the materialized
view should be populated at creation time. If not, the materialized view
cannot be queried until you invoke REFRESH MATERIALIZED VIEW.</p></li>
<li><p>Use the drop-down listbox next to <em>Tablespace</em> to select a location for the
materialized view.</p></li>
<li><p>Use the <em>Fill Factor</em> field to specify a fill factor for the materialized
...
<img alt="Materialized view dialog parameter tab" class="align-center" src="_images/materialized_view_parameter.png" />
...
for the table and the associated toast table. To change the default values:</p>
<ul class="simple">
<li><p>Move the <em>Custom auto-vacuum?</em> switch to the <em>Yes</em> position to perform custom
maintenance on the materialized view.</p></li>
<li><p>Move the <em>Enabled?</em> switch to the <em>Yes</em> position to select values in the
<em>Vacuum table</em>. Provide values for each row in the <em>Value</em> column.</p></li>
</ul>
<p>Click the <em>Security</em> tab to continue.</p>
<img alt="Materialized view dialog security tab" class="align-center" src="_images/materialized_view_security.png" />
...
(+) to set privileges for the materialized view:</p>
<ul class="simple">
...
<li><p>Select the name of the role from the drop-down listbox in the <em>Grantor</em>
field. The default grantor is the owner of the database.</p></li>
</ul>
...
materialized view. Click the <em>Add</em> icon (+) to add each security label
selection:</p>
<ul class="simple">
...
<p>Your entries in the <em>Materialized View</em> dialog generate a SQL command (see an
...
the <em>Materialized View</em> dialog:</p>
<img alt="Materialized view dialog sql tab" class="align-center" src="_images/materialized_view_sql.png" />
<p>The example shown creates a query named <em>new_hires</em> that stores the result of
the displayed query in the <em>pg_default</em> tablespace.</p>
<ul class="simple">
...
<li><p>Click the <em>Reset</em> button to restore configuration parameters.</p></li>
  ...
  <ul>
<li><a class="reference internal" href="#">Materialized View Dialog</a><ul>
