...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    <meta charset="utf-8" />
    <title>Primary key Dialog &#8212; pgAdmin 4 4.11 documentation</title>
...
<p>Use the <em>Primary key</em> dialog to create or modify a primary key constraint. A
...
column(s) be both unique and not null.</p>
<p>The <em>Primary key</em> dialog organizes the development of a primary key constraint
through the <em>General</em> and <em>Definition</em> tabs. The <em>SQL</em> tab displays the SQL code
generated by dialog selections.</p>
<img alt="Primary key dialog general tab" class="align-center" src="_images/primary_key_general.png" />
...
<img alt="Primary key dialog definition tab" class="align-center" src="_images/primary_key_definition.png" />
...
<li><p>Use <em>Include columns</em> field to specify columns for <em>INCLUDE</em> clause of the
index. This option is available in Postgres 11 and later.</p></li>
...
<li><p>Select the name of an index from the drop-down listbox in the <em>Index</em> field.
...
key, and will force the column(s) to be marked NOT NULL.</p></li>
...
<p>Your entries in the <em>Primary key</em> dialog generate a SQL command (see an example
...
the <em>Primary key</em> dialog:</p>
<img alt="Primary key dialog sql tab" class="align-center" src="_images/primary_key_sql.png" />
<p>The example shown demonstrates creating a primary key constraint named
<em>dept_pkey</em> on the <em>dept_id</em> column of the <em>dept</em> table.</p>
<ul class="simple">
...
<li><p>Click the <em>Reset</em> button to restore configuration parameters.</p></li>
  ...
  <ul>
<li><a class="reference internal" href="#">Primary key Dialog</a><ul>
