...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    <meta charset="utf-8" />
    <title>Version 3.6 &#8212; pgAdmin 4 4.11 documentation</title>
    ...
    <link rel="next" title="Version 3.5" href="release_notes_3_5.html" />
    <link rel="prev" title="Version 4.0" href="release_notes_4_0.html" /> 
  </head><body>
    <div class="related" role="navigation" aria-label="related navigation">
      ...
      <ul>
        ...
        <li class="right" >
          <a href="release_notes_3_5.html" title="Version 3.5"
             accesskey="N">next</a> |</li>
        <li class="right" >
          <a href="release_notes_4_0.html" title="Version 4.0"
  ...
  <div class="section" id="version-3-6">
<h1>Version 3.6<a class="headerlink" href="#version-3-6" title="Permalink to this headline">¶</a></h1>
<p>Release date: 2018-11-29</p>
<p>This release contains a number of features and fixes reported since the release
of pgAdmin4 3.5</p>
<div class="section" id="features">
<h2>Features<a class="headerlink" href="#features" title="Permalink to this headline">¶</a></h2>
<div class="line-block">
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/1513">Issue #1513</a> - Add support for dropping multiple objects at once from the collection Properties panel.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/3772">Issue #3772</a> - Add the ability to import and export server definitions from a config database.</div>
</div>
</div>
<div class="section" id="bug-fixes">
<h2>Bug fixes<a class="headerlink" href="#bug-fixes" title="Permalink to this headline">¶</a></h2>
<div class="line-block">
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/3016">Issue #3016</a> - Ensure previous notices are not removed from the Messages tab in the Query Tool if an error occurs during query execution.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/3029">Issue #3029</a> - Allow the selection order to be preserved in the Select2 control to fix column ordering in data Import/Export.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/3629">Issue #3629</a> - Allow use of 0 (integer) and empty strings as parameters in the debugger.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/3723">Issue #3723</a> - Properly report errors when debugging cannot be started.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/3734">Issue #3734</a> - Prevent the debugger controls being pressed again before previous processing is complete.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/3736">Issue #3736</a> - Fix toggle breakpoints buttons in the debugger.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/3742">Issue #3742</a> - Fix changes to the NOT NULL and default value options in the Table Dialogue.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/3746">Issue #3746</a> - Fix dropping of multiple functions/procedures at once.</div>
</div>
</div>
</div>
  ...
  <ul>
<li><a class="reference internal" href="#">Version 3.6</a><ul>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">Version 3.6</a></li>
