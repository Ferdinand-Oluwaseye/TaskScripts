...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    <meta charset="utf-8" />
    <title>Synonym Dialog &#8212; pgAdmin 4 4.11 documentation</title>
...
<p>Use the <em>Synonym</em> dialog to substitute the name of a target object with a
user-defined synonym.</p>
<p>The <em>Synonym</em> dialog organizes the development of a synonym through the
<em>General</em> tab. The <em>SQL</em> tab displays the SQL code generated by dialog
selections.</p>
<img alt="Synonym dialog general tab" class="align-center" src="_images/synonym_general.png" />
<p>Use the fields in the <em>General</em> tab to identify the synonym:</p>
<ul class="simple">
<li><p>Use the <em>Name</em> field to specify the name of synonym. The name will be
displayed in the <em>pgAdmin</em> tree control.</p></li>
<li><p>Select the name of the schema in which the synonym will reside from the
drop-down listbox in the <em>Schema</em> field.</p></li>
</ul>
<p>In the definition panel, identify the target:</p>
<ul class="simple">
<li><p>Use the drop-down listbox next to <em>Target Type</em> to select the the type of
object referenced by the synonym.</p></li>
<li><p>Use the drop-down listbox next to <em>Target Schema</em> to select the name of the
schema in which the object resides.</p></li>
<li><p>Use the drop-down listbox next to <em>Target Object</em> to select the name of the
object referenced by the synonym.</p></li>
</ul>
...
<img alt="Synonym dialog sql tab" class="align-center" src="_images/synonym_sql.png" />
