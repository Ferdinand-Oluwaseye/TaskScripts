...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    <meta charset="utf-8" />
    <title>Sequence Dialog &#8212; pgAdmin 4 4.11 documentation</title>
...
<p>Use the <em>Sequence</em> dialog to create a sequence.  A sequence generates unique
values in a sequential order (not necessarily contiguous).</p>
<p>The <em>Sequence</em> dialog organizes the development of a sequence through the
following dialog tabs: <em>General</em>, <em>Definition</em>, and <em>Security</em>. The <em>SQL</em> tab
displays the SQL code generated by dialog selections.</p>
<img alt="Sequence dialog general tab" class="align-center" src="_images/sequence_general.png" />
<p>Use the fields in the <em>General</em> tab to identify a sequence:</p>
<ul class="simple">
<li><p>Use the <em>Name</em> field to add a descriptive name for the sequence. The name will
be displayed in the <em>pgAdmin</em> tree control.  The sequence name must be
distinct from the name of any other sequence, table, index, view, or foreign
table in the same schema.</p></li>
<li><p>Use the drop-down listbox next to <em>Owner</em> to select the name of the role that
will own the sequence.</p></li>
<li><p>Use the drop-down listbox next to <em>Schema</em> to select the schema in which the
sequence will reside.</p></li>
<li><p>Store notes about the sequence in the <em>Comment</em> field.</p></li>
</ul>
<p>Click the <em>Definition</em> tab to continue.</p>
<img alt="Sequence dialog definition tab" class="align-center" src="_images/sequence_definition.png" />
...
<img alt="Sequence dialog security tab" class="align-center" src="_images/sequence_security.png" />
<p>Use the <em>Security</em> tab to assign privileges and define security labels for the
sequence.</p>
<p>Use the <em>Privileges</em> panel to assign privileges. Click the <em>Add</em> icon (+) to
set privileges:</p>
<ul class="simple">
<li><p>Select the name of a role that will be granted privileges from the drop-down
...
sequence. Click the <em>Add</em> icon (+) to add each security label selection:</p>
<ul class="simple">
...
<p>Your entries in the <em>Sequence</em> dialog generate a generate a SQL command (see an
...
the <em>Sequence</em> dialog:</p>
<img alt="Sequence dialog sql tab" class="align-center" src="_images/sequence_sql.png" />
<p>The example shown demonstrates a sequence named <em>seconds</em>. The sequence will
increase in <em>5</em> second increments, and stop when it reaches a maximum value
equal of <em>60</em>.</p>
<ul class="simple">
...
<li><p>Click the <em>Reset</em> button to restore configuration parameters.</p></li>
  ...
  <ul>
<li><a class="reference internal" href="#">Sequence Dialog</a><ul>
