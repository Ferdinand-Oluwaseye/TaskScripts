...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    <meta charset="utf-8" />
    <title>Login Dialog &#8212; pgAdmin 4 4.11 documentation</title>
    ...
    <link rel="next" title="User Management Dialog" href="user_management.html" />
    <link rel="prev" title="Container Deployment" href="container_deployment.html" /> 
  </head><body>
  ...
  <div class="section" id="login-dialog">
<span id="login"></span><h1><span class="target" id="index-0"></span>Login Dialog<a class="headerlink" href="#login-dialog" title="Permalink to this headline">¶</a></h1>
<p>Use the <em>Login</em> dialog to log in to pgAdmin:</p>
<img alt="pgAdmin login dialog" class="align-center" src="_images/login.png" />
<p>Use the fields in the <em>Login</em> dialog to authenticate your connection:</p>
<ul class="simple">
...
<li><p>Click the <em>Login</em> button to securely log into pgAdmin.</p></li>
<li><p>Please note that, if the pgAdmin server is restarted then you will be logged out. You need to re-login to continue.</p></li>
</ul>
<div class="section" id="recovering-a-lost-password">
<h2>Recovering a Lost Password<a class="headerlink" href="#recovering-a-lost-password" title="Permalink to this headline">¶</a></h2>
...
<img alt="pgAdmin recover login password" class="align-center" src="_images/login_recover.png" />
<ul class="simple">
<li><p>Provide the email address associated with your account in the <em>Email Address</em>
field.</p></li>
