...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    <meta charset="utf-8" />
    <title>Rule Dialog &#8212; pgAdmin 4 4.11 documentation</title>
...
<p>Use the <em>Rule</em> dialog to define or modify a rule for a specified table or view.
A PostgreSQL rule allows you to define an additional action that will be
performed when a SELECT, INSERT, UPDATE, or DELETE is performed against a table.</p>
<p>The <em>Rule</em> dialog organizes the development of a rule through the <em>General</em>,
and <em>Definition</em> tabs. The <em>SQL</em> tab displays the SQL code generated by dialog
selections.</p>
<img alt="Rule dialog general tab" class="align-center" src="_images/rule_general.png" />
<p>Use the fields in the <em>General</em> tab to identify the rule:</p>
<ul class="simple">
<li><p>Use the <em>Name</em> field to add a descriptive name for the rule. The name will be
displayed in the <em>pgAdmin</em> tree control. Multiple rules on the same table are
applied in alphabetical name order.</p></li>
<li><p>Store notes about the rule in the <em>Comment</em> field.</p></li>
</ul>
<p>Click the <em>Definition</em> tab to continue.</p>
<img alt="Rule dialog definition tab" class="align-center" src="_images/rule_definition.png" />
<p>Use the fields in the <em>Definition</em> tab to write parameters:</p>
<ul class="simple">
<li><p>Click inside the <em>Event</em> field to select the type of event that will invoke
the rule; event may be <em>Select</em>, <em>Insert</em>, <em>Update</em>, or <em>Delete</em>.</p></li>
<li><p>Move the <em>Do Instead</em> switch to <em>Yes</em> indicate that the commands should be
executed instead of the original command; if Do Instead specifies <em>No</em>, the
rule will be invoked in addition to the original command.</p></li>
<li><p>Specify a SQL conditional expression that returns a boolean value in the
<em>Condition</em> editor.</p></li>
<li><p>Provide a command in the <em>Commands</em> editor that defines the action performed
by the rule.</p></li>
</ul>
<p>Click the <em>SQL</em> tab to continue.</p>
<p>Your entries in the <em>Rule</em> dialog generate a SQL command (see an example below).
...
the <em>Rule</em> dialog:</p>
<img alt="Rule dialog sql tab" class="align-center" src="_images/rule_sql.png" />
...
<li><p>Click the <em>Reset</em> button to restore configuration parameters.</p></li>
  ...
  <ul>
<li><a class="reference internal" href="#">Rule Dialog</a><ul>
