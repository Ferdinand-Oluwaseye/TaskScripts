...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    <meta charset="utf-8" />
    <title>Package Dialog &#8212; pgAdmin 4 4.11 documentation</title>
...
<p>The <em>Package</em> dialog organizes the management of a package through the following
dialog tabs: <em>General</em>, <em>Code</em>, and <em>Security</em>. The <em>SQL</em> tab displays the SQL
code generated by dialog selections.</p>
<img alt="Package dialog general tab" class="align-center" src="_images/package_general.png" />
<p>Use the fields in the <em>General</em> tab to identify the package:</p>
<ul class="simple">
<li><p>Use the <em>Name</em> field to add a descriptive name for the package. The name of a
new package must not match any existing package in the same schema.</p></li>
<li><p>Select the schema in which the package will reside from the drop-down listbox
in the <em>Schema</em> field.</p></li>
<li><p>Store notes about the package in the <em>Comment</em> field.</p></li>
</ul>
<p>Click the <em>Code</em> tab to continue.</p>
<img alt="Package dialog code tab" class="align-center" src="_images/package_code.png" />
<p>Use the fields in the <em>Code</em> tab to specify the package contents and to provide
implementation details:</p>
<ul class="simple">
<li><p>Use the <em>Header</em> field to define the public interface for the package.</p></li>
<li><p>Use the <em>Body</em> field to provide the code that implements each package object.</p></li>
</ul>
<p>Click the <em>Security</em> tab to continue.</p>
<img alt="Package dialog security tab" class="align-center" src="_images/package_security.png" />
<p>Use the fields in the <em>Security</em> tab to to assign EXECUTE privileges for the
package to a role. Click the <em>Add</em> icon (+) to set privileges for the package:</p>
<ul class="simple">
<li><p>Select the name of the role from the drop-down listbox in the <em>Grantee</em> field.</p></li>
<li><p>Click inside the <em>Privileges</em> field. Check the boxes to the left of a
privilege to grant the selected privilege to the specified user.</p></li>
<li><p>Select the name of a role from the drop-down listbox in the <em>Grantor</em> field.
The default grantor is the owner of the package.</p></li>
</ul>
...
<p>Your entries in the <em>Package</em> dialog generate a SQL command that creates or
modifies a package definition:</p>
<img alt="Package dialog sql tab" class="align-center" src="_images/package_sql.png" />
<p>The example shown demonstrates creating a package named <em>empinfo</em> that includes
one function and one procedure.</p>
<ul class="simple">
<li><p>Click the <em>Save</em> button to save work.</p></li>
<li><p>Click the <em>Cancel</em> button to exit without saving work.</p></li>
<li><p>Click the <em>Reset</em> button to delete any changes to the dialog.</p></li>
</ul>
</div>
