...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    <meta charset="utf-8" />
    <title>Cast Dialog &#8212; pgAdmin 4 4.11 documentation</title>
...
of the cast.</p></li>
<li><p>Move the <em>Context</em> switch to the <em>Implicit</em> position if the cast is implicit.
...
<p>The cast uses a function named <em>int4(bigint)</em> to convert a biginteger data type
to an integer.</p>
<ul class="simple">
