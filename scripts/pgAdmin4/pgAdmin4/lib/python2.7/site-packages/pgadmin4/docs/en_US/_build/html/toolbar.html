...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    <meta charset="utf-8" />
    <title>Toolbar &#8212; pgAdmin 4 4.11 documentation</title>
    ...
    <link rel="next" title="Tabbed Browser" href="tabbed_browser.html" />
    <link rel="prev" title="Menu Bar" href="menu_bar.html" /> 
  </head><body>
...
<span id="id1"></span><h1><span class="target" id="index-0"></span>Toolbar<a class="headerlink" href="#toolbar" title="Permalink to this headline">¶</a></h1>
<p>The pgAdmin toolbar provides shortcut buttons for frequently used features like
...
the selected browser node.</p>
<img alt="pgAdmin Toolbar" class="align-center" src="_images/toolbar.png" />
<ul class="simple">
<li><p>Use the <a class="reference internal" href="query_tool.html#query-tool"><span class="std std-ref">Query Tool</span></a> button to open the Query Tool in the
current database context.</p></li>
<li><p>Use the <a class="reference internal" href="editgrid.html#editgrid"><span class="std std-ref">View Data</span></a> button to view/edit the data stored in a
selected table.</p></li>
<li><p>Use the <a class="reference internal" href="editgrid.html#editgrid"><span class="std std-ref">Filtered Rows</span></a> button to access the Data Filter popup
to apply a filter to a set of data for viewing/editing.</p></li>
</ul>
</div>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">Toolbar</a></li>
