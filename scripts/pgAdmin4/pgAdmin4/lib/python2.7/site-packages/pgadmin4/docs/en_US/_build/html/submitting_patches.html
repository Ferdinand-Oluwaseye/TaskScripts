...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    <meta charset="utf-8" />
    <title>Submitting Patches &#8212; pgAdmin 4 4.11 documentation</title>
...
<div class="highlight-bash notranslate"><div class="highlight"><pre><span></span>$ git clone git://git.postgresql.org/git/pgadmin4.git
</pre></div>
</div>
...
might run:</p>
<div class="highlight-bash notranslate"><div class="highlight"><pre><span></span>$ git diff origin/master &gt; my_cool_feature.diff
</pre></div>
</div>
...
<div class="highlight-bash notranslate"><div class="highlight"><pre><span></span>$ git diff &gt; my_cool_feature.diff
</pre></div>
</div>
...
<div class="highlight-bash notranslate"><div class="highlight"><pre><span></span>$ git add file1.py file2.py images/image1.png <span class="o">[</span>...<span class="o">]</span>
