...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    <meta charset="utf-8" />
    <title>Column Dialog &#8212; pgAdmin 4 4.11 documentation</title>
...
is required.</p></li>
<li><p>Use the <em>Length</em> and <em>Precision</em> fields to specify the maximum number of
...
<p>Use the <em>Variables</em> tab to to specify the number of distinct values that may be
...
<p>The example shown demonstrates creating a column named <em>territory</em> in the table
named <em>distributors</em>.</p>
<ul class="simple">
