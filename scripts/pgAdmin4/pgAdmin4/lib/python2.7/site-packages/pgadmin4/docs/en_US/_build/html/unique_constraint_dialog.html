...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    <meta charset="utf-8" />
    <title>Unique Constraint Dialog &#8212; pgAdmin 4 4.11 documentation</title>
...
<p>Use the <em>Unique constraint</em> dialog to define a unique constraint for a specified
table. Unique constraints ensure that the data contained in a column, or a group
of columns, is unique among all the rows in the table.</p>
<p>The <em>Unique constraint</em> dialog organizes the development of a unique constraint
...
<img alt="Unique Constraint dialog general tab" class="align-center" src="_images/unique_constraint_general.png" />
<p>Use the fields in the <em>General</em> tab to identify the unique constraint:</p>
<ul class="simple">
<li><p>Use the <em>Name</em> field to add a descriptive name for the unique constraint.
The name will be displayed in the <em>pgAdmin</em> tree control.</p></li>
</ul>
<p>Click the <em>Definition</em> tab to continue.</p>
<img alt="Unique Constraint dialog definition tab" class="align-center" src="_images/unique_constraint_definition.png" />
...
constraint. This option is available in Postgres 11 and later.</p></li>
...
constraint, and will force the column(s) to be marked NOT NULL.</p></li>
...
<p>Your entries in the <em>Unique constraint</em> dialog generate a SQL command (see an
...
the <em>Unique constraint</em> dialog:</p>
<img alt="Unique Constraint dialog sql tab" class="align-center" src="_images/unique_constraint_sql.png" />
<p>The example shown demonstrates creating a unique constraint named <em>name_con</em> on
the <em>name</em> column of the <em>distributors</em> table.</p>
<ul class="simple">
...
<li><p>Click the <em>Reset</em> button to restore configuration parameters.</p></li>
  ...
  <ul>
<li><a class="reference internal" href="#">Unique Constraint Dialog</a><ul>
