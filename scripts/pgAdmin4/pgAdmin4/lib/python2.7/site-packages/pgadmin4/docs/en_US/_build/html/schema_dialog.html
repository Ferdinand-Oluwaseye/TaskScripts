...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    <meta charset="utf-8" />
    <title>Schema Dialog &#8212; pgAdmin 4 4.11 documentation</title>
...
<p>Use the <em>Schema</em> dialog to define a schema. A schema is the organizational
workhorse of a database, similar to directories or namespaces. To create a
schema, you must be a database superuser or have the CREATE privilege.</p>
<p>The <em>Schema</em> dialog organizes the development of schema through the following
dialog tabs: <em>General</em> and <em>Security</em>. The <em>SQL</em> tab displays the SQL code
generated by dialog selections.</p>
<img alt="Schema dialog general tab" class="align-center" src="_images/schema_general.png" />
<p>Use the fields on the <em>General</em> tab to identify the schema.</p>
<ul class="simple">
<li><p>Use the <em>Name</em> field to add a descriptive name for the schema. The name will
be displayed in the <em>pgAdmin</em> tree control.</p></li>
<li><p>Select the owner of the schema from the drop-down listbox in the <em>Owner</em>
field.</p></li>
<li><p>Store notes about the schema in the <em>Comment</em> field.</p></li>
</ul>
<p>Click the <em>Security</em> tab to continue.</p>
<img alt="Schema dialog security tab" class="align-center" src="_images/schema_security.png" />
<p>Use the <em>Security</em> tab to assign privileges and security labels for the schema.</p>
<p>Click the <em>Add</em> icon (+) to assign a set of privileges in the <em>Privileges</em>
panel:</p>
<ul class="simple">
...
<li><p>Select the name of the role that is granting the privilege from the drop-down
...
<p>Click the <em>Add</em> icon (+) to assign a security label in the <em>Security Labels</em>
panel:</p>
<ul class="simple">
...
<img alt="Schema dialog default privileges tab" class="align-center" src="_images/schema_default_privileges.png" />
<p>Use the <em>Default Privileges</em> tab to grant privileges for tables, sequences,
functions and types. Use the tabs nested inside the <em>Default Privileges</em> tab to
specify the database object and click the <em>Add</em> icon (+) to assign a set of
privileges:</p>
<ul class="simple">
<li><p>Select the name of a role that will be granted privileges in the schema from
the drop-down listbox in the <em>Grantee</em> field.</p></li>
<li><p>Click inside the <em>Privileges</em> field. Check the boxes to the left of one or
more privileges to grant the selected privileges to the specified user.</p></li>
<li><p>Select the name of the role that is granting the privilege from the drop-down
listbox in the <em>Grantor</em> field. The default grantor is the owner of the schema.</p></li>
</ul>
<p>Click the <em>SQL</em> tab to continue.</p>
<p>Your entries in the <em>Schema</em> dialog generate a SQL command (see an example
...
the <em>Schema</em> dialog:</p>
<img alt="Schema dialog sql tab" class="align-center" src="_images/schema_sql.png" />
<p>The example creates a schema named hr; the command grants <em>USAGE</em> privileges to
<em>public</em> and assigns the ability to grant privileges to <em>alice</em>.</p>
<ul class="simple">
...
<li><p>Click the <em>Reset</em> button to restore configuration parameters.</p></li>
  ...
  <ul>
<li><a class="reference internal" href="#">Schema Dialog</a><ul>
