...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    <meta charset="utf-8" />
    <title>FTS Template Dialog &#8212; pgAdmin 4 4.11 documentation</title>
...
<p>Use the <em>FTS Template</em> dialog to create a new text search template. A text
search template defines the functions that implement text search dictionaries.</p>
<p>The <em>FTS Template</em> dialog organizes the development of a text search Template
...
<img alt="FTS template dialog general tab" class="align-center" src="_images/fts_template_general.png" />
<p>Use the fields in the <em>General</em> tab to identify a template:</p>
<ul class="simple">
<li><p>Use the <em>Name</em> field to add a descriptive name for the template. The name will
be displayed in the <em>pgAdmin</em> tree control.</p></li>
<li><p>Select the name of the schema in which the template will reside from the
drop-down listbox in the <em>Schema</em> field.</p></li>
<li><p>Store notes about the template in the <em>Comment</em> field.</p></li>
</ul>
<p>Click the <em>Definition</em> tab to continue.</p>
<img alt="FTS template dialog definition tab" class="align-center" src="_images/fts_template_definition.png" />
<p>Use the fields in the <em>Definition</em> tab to define function parameters:</p>
<ul class="simple">
<li><p>Use the drop-down listbox next to <em>Init function</em> to select the name of the
init function for the template. The init function is optional.</p></li>
<li><p>Use the drop-down listbox next to <em>Lexize function</em> to select the name of the
lexize function for the template. The lexize function is required.</p></li>
</ul>
<p>Click the <em>SQL</em> tab to continue.</p>
<p>Your entries in the <em>FTS Template</em> dialog generate a SQL command (see an example
...
the <em>FTS Template</em> dialog:</p>
<img alt="FTS template dialog sql tab" class="align-center" src="_images/fts_template_sql.png" />
<p>The example shown demonstrates creating a fts template named <em>ru_template</em> that
uses the ispell dictionary.</p>
<ul class="simple">
...
<li><p>Click the <em>Reset</em> button to restore configuration parameters.</p></li>
  ...
  <ul>
<li><a class="reference internal" href="#">FTS Template Dialog</a><ul>
