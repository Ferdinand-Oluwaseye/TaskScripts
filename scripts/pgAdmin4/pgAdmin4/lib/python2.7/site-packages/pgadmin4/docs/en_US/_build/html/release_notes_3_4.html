...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    <meta charset="utf-8" />
    <title>Version 3.4 &#8212; pgAdmin 4 4.11 documentation</title>
    ...
    <link rel="prev" title="Version 3.5" href="release_notes_3_5.html" /> 
  </head><body>
...
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/2927">Issue #2927</a> - Move all CSS into SCSS files for consistency and ease of colour maintenance etc.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/3514">Issue #3514</a> - Add optional data point markers and mouse-over tooltips to display values on graphs.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/3564">Issue #3564</a> - Add shortcuts for View Data and the Query tool to the Browser header bar.</div>
</div>
</div>
<div class="section" id="bug-fixes">
<h2>Bug fixes<a class="headerlink" href="#bug-fixes" title="Permalink to this headline">¶</a></h2>
<div class="line-block">
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/3464">Issue #3464</a> - Ensure the runtime can startup properly if there are wide characters in the logfile path on Windows.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/3551">Issue #3551</a> - Fix handling of backslashes in the edit grid.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/3576">Issue #3576</a> - Ensure queries are no longer executed when dashboards are closed.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/3596">Issue #3596</a> - Fix support for the CLOB datatype in EPAS.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/3607">Issue #3607</a> - Fix logic around validation and highlighting of Sort/Filter in the Query Tool.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/3630">Issue #3630</a> - Ensure auto-complete works for objects in schemas other than public and pg_catalog.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/3657">Issue #3657</a> - Ensure changes to Query Tool settings from the Preferences dialogue are applied before executing queries.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/3658">Issue #3658</a> - Swap the Schema and Schemas icons and Catalog and Catalogs icons that had been used the wrong way around.</div>
</div>
</div>
</div>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">Version 3.4</a></li>
