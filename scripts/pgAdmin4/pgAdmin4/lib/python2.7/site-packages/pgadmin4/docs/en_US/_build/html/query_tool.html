...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    <meta charset="utf-8" />
    <title>Query Tool &#8212; pgAdmin 4 4.11 documentation</title>
...
<li><p>Review the execution plan of a SQL statement in either a text or a graphical
format.</p></li>
...
simultaneously.  To close a copy of the Query tool, click the <em>X</em> in the
upper-right hand corner of the tab bar.</p>
<p>The Query Tool features two panels:</p>
<ul class="simple">
<li><p>The upper panel displays the <em>SQL Editor</em>. You can use the panel to enter,
edit, or execute a query. It also shows the <em>History</em> tab which can be used
...
<h2>Toolbar<a class="headerlink" href="#toolbar" title="Permalink to this headline">¶</a></h2>
...
<li class="toctree-l2"><a class="reference internal" href="query_tool_toolbar.html#editing-options">Editing Options</a></li>
<li class="toctree-l2"><a class="reference internal" href="query_tool_toolbar.html#view-edit-data-resultset-control">View/Edit Data Resultset Control</a></li>
...
<div class="section" id="the-sql-editor-panel">
<h2>The SQL Editor Panel<a class="headerlink" href="#the-sql-editor-panel" title="Permalink to this headline">¶</a></h2>
...
<p>After entering a query, select the <em>Execute/Refresh</em> icon from the toolbar. The
...
<img alt="Query tool execute query section" class="align-center" src="_images/query_execute_section.png" />
...
<div class="section" id="the-data-output-panel">
<h2>The Data Output Panel<a class="headerlink" href="#the-data-output-panel" title="Permalink to this headline">¶</a></h2>
...
<li><p>Use the <em>Execute/Refresh</em> options to retrieve query execution information and
set query execution options.</p></li>
<li><p>Use the <em>Download as CSV</em> icon to download the content of the <em>Data Output</em>
...
<ul class="simple">
<li><p>All the columns belong to the same table.</p></li>
<li><p>All the primary keys of the table are selected.</p></li>
<li><p>No columns are duplicated.</p></li>
</ul>
<p>An updatable result set can be modified just like in
<a class="reference internal" href="editgrid.html#modifying-data-grid"><span class="std std-ref">View/Edit Data</span></a> mode.</p>
...
<img alt="Query tool explain panel" class="align-center" src="_images/query_output_explain.png" />
<p>To generate a graphical explain diagram, open the <em>Explain</em> tab, and select
<em>Explain</em>, <em>Explain Analyze</em>, or one or more options from the <em>Explain options</em>
drop-down. Please note that <em>EXPLAIN VERBOSE</em>
cannot be displayed graphically. Hover over an icon on the <em>Explain</em> tab to
...
be displayed when appropriate.</p>
...
<p>To erase the content of the <em>Query History</em> tab, select <em>Clear history</em> from
the <em>Clear</em> drop-down menu.</p>
...
can be adjusted in <cite>config_local.py</cite> by overriding the <cite>MAX_QUERY_HIST_STORED</cite>
value. See the <a class="reference internal" href="deployment.html#deployment"><span class="std std-ref">Deployment</span></a> section for more information.</p>
