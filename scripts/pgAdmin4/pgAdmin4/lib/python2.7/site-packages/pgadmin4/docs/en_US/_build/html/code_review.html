...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    <meta charset="utf-8" />
    <title>Code Review Notes &#8212; pgAdmin 4 4.11 documentation</title>
...
<blockquote>
<div><p>Copyright (C) 2013 - 2019, The pgAdmin Development Team</p>
</div></blockquote>
</li>
...
<li><p>1 patch == 1 feature. If you need to fix/update existing infrastructure in
your patch, it’s usually easier if it’s in a separate patch. Patches containing
multiple new features or unrelated changes are likely to be rejected.</p></li>
<li><p>Ensure the patch is fully functional, and works! If a patch is being sent as
a work in progress, not intended for commit, clearly state that it’s a WIP,
and note what does or does not yet work.</p></li>
</ul>
</div>
