...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    <meta charset="utf-8" />
    <title>User Interface &#8212; pgAdmin 4 4.11 documentation</title>
...
<span id="id1"></span><h1><span class="target" id="index-0"></span>User Interface<a class="headerlink" href="#user-interface" title="Permalink to this headline">¶</a></h1>
<p>pgAdmin 4 supports all PostgreSQL features, from writing simple SQL queries to
developing complex databases. It is designed to query an active database (in
real-time), allowing you to stay current with modifications and implementations.</p>
<p>Features of pgAdmin 4 include:</p>
<ul class="simple">
<li><p>auto-detection and support for objects discovered at run-time</p></li>
<li><p>a live SQL Query Tool with direct data editing</p></li>
<li><p>support for administrative queries</p></li>
<li><p>a syntax-highlighting SQL editor</p></li>
<li><p>redesigned graphical interfaces</p></li>
<li><p>powerful management dialogs and tools for common tasks</p></li>
<li><p>responsive, context-sensitive behavior</p></li>
<li><p>supportive error messages</p></li>
<li><p>helpful hints</p></li>
<li><p>online help and information about using pgAdmin dialogs and tools.</p></li>
</ul>
<p>When pgAdmin opens, the interface features a menu bar and a window divided into
two panes: the <em>Browser</em> tree control in the left pane, and a tabbed browser in
the right pane.</p>
<img alt="pgAdmin4 welcome page" class="align-center" src="_images/welcome.png" />
<p>Select an icon from the <em>Quick Links</em> panel on the <em>Dashboard</em> tab to:</p>
<ul class="simple">
<li><p>Click the <em>Add New Server</em> button to open the
<a class="reference internal" href="server_dialog.html#server-dialog"><span class="std std-ref">Create - Server dialog</span></a> to add a new server definition.</p></li>
<li><p>Click the <em>Configure pgAdmin</em> button to open the
<a class="reference internal" href="preferences.html#preferences"><span class="std std-ref">Preferences dialog</span></a> to customize your pgAdmin client.</p></li>
</ul>
<p>Links in the <em>Getting Started</em> panel open a new browser tab that provide useful
information for Postgres users:</p>
<ul class="simple">
<li><p>Click the <em>PostgreSQL Documentation</em> link to navigate to the <em>Documentation</em>
...
server.</p></li>
<li><p>Click the <em>pgAdmin Website</em> link to navigate to the pgAdmin project website.
The pgAdmin site features news about recent pgAdmin releases and other project
information.</p></li>
<li><p>Click the <em>Planet PostgreSQL</em> link to navigate to the blog aggregator for
Postgres related blogs.</p></li>
<li><p>Click the <em>Community Support</em> link to navigate to the <em>Community</em> page at the
PostgreSQL open-source project site; this page provides information about
obtaining support for PostgreSQL features.</p></li>
</ul>
</div>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">User Interface</a></li>
