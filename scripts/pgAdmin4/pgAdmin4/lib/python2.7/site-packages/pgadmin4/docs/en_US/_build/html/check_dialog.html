...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    <meta charset="utf-8" />
    <title>Check Dialog &#8212; pgAdmin 4 4.11 documentation</title>
...
<p>The example shown demonstrates creating a check constraint named <em>check_price</em>
on the <em>price</em> column of the <em>products</em> table.  The constraint confirms that
any values added to the column are greater than 0.</p>
<ul class="simple">
