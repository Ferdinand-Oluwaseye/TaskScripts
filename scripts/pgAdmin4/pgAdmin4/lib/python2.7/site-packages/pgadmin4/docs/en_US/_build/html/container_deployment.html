...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    <meta charset="utf-8" />
    <title>Container Deployment &#8212; pgAdmin 4 4.11 documentation</title>
    ...
    <link rel="next" title="Login Dialog" href="login.html" />
...
<h2>PostgreSQL Utilities<a class="headerlink" href="#postgresql-utilities" title="Permalink to this headline">¶</a></h2>
...
server:</p>
<ul class="simple">
<li><p>PostgreSQL 9.4: <em>/usr/local/pgsql-9.4</em></p></li>
<li><p>PostgreSQL 9.5: <em>/usr/local/pgsql-9.5</em></p></li>
<li><p>PostgreSQL 9.6: <em>/usr/local/pgsql-9.6</em></p></li>
<li><p>PostgreSQL 10: <em>/usr/local/pgsql-10</em></p></li>
<li><p>PostgreSQL 11: <em>/usr/local/pgsql-11</em></p></li>
</ul>
...
<p><em>PGADMIN_SERVER_JSON_FILE</em></p>
<p>Default: /pgadmin4/servers.json</p>
...
<h2>Reverse Proxying<a class="headerlink" href="#reverse-proxying" title="Permalink to this headline">¶</a></h2>
...
<h3>HTTP via Nginx<a class="headerlink" href="#http-via-nginx" title="Permalink to this headline">¶</a></h3>
...
<h3>HTTPS via Nginx<a class="headerlink" href="#https-via-nginx" title="Permalink to this headline">¶</a></h3>
