...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    <meta charset="utf-8" />
    <title>View Dialog &#8212; pgAdmin 4 4.11 documentation</title>
...
<p>Use the <em>View</em> dialog to define a view. The view is not physically materialized;
the query is executed each time the view is referenced in a query.</p>
<p>The <em>View</em> dialog organizes the development of a View through the following
dialog tabs: <em>General</em>, <em>Definition</em>, and <em>Security</em>”. The <em>SQL</em> tab displays
the SQL code generated by dialog selections.</p>
<p>Click the <em>General</em> tab to begin.</p>
<img alt="View dialog general tab" class="align-center" src="_images/view_general.png" />
<p>Use the fields in the <em>General</em> tab to identify a view:</p>
<ul class="simple">
<li><p>Use the <em>Name</em> field to add a descriptive name for the view. The name of the
...
<em>pgAdmin</em> tree control.</p></li>
<li><p>Use the drop-down listbox next to <em>Owner</em> to select the role that will own the
view.</p></li>
<li><p>If applicable, select the name of the schema in which the view will reside
from the drop-down listbox in the <em>Schema</em> field.</p></li>
<li><p>Store notes about the view in the <em>Comments</em> field.</p></li>
</ul>
<p>Click the <em>Definition</em> tab to continue.</p>
<img alt="View dialog definition tab" class="align-center" src="_images/view_definition.png" />
<p>Use the fields in the <em>Definition</em> tab to define properties of the view:</p>
<ul class="simple">
<li><p>Set the <em>Security Barrier</em> switch to <em>Yes</em> to indicate that the view is to act
as a security barrier.  For more information about defining and using a
security barrier rule, see Section 38.5 of the PostgreSQL documentation.</p></li>
<li><p>Use the drop-down listbox next to <em>Check options</em> to select from <em>No</em>, <em>Local</em>
or <em>Cascaded</em>:</p>
<ul>
<li><p>The <em>Local</em> option specifies that new rows are only checked against the
conditions defined in the view. Any conditions defined on underlying base
views are not checked (unless you specify the CHECK OPTION).</p></li>
<li><p>The <em>Cascaded</em> option specifies new rows are checked against the conditions
of the view and all underlying base views.</p></li>
</ul>
</li>
<li><p>Use the workspace in the <em>Definition</em> field to write a query to create a view.</p></li>
</ul>
<p>Click the <em>Security</em> tab to continue.</p>
<img alt="View dialog security tab" class="align-center" src="_images/view_security.png" />
...
(+) to set privileges for the view:</p>
<ul class="simple">
<li><p>Select the name of the role that will be granted privileges from the drop-down
listbox in the <em>Grantee</em> field.</p></li>
...
<li><p>Select the name of a role with sufficient privileges to grant privileges on
the view from the drop-down listbox in the <em>Grantor</em> field. The default
grantor is the owner of the database.</p></li>
</ul>
<p>Click the <em>Add</em> icon (+) to assign additional privileges; to discard a
privilege, click the trash icon to the left of the row and confirm deletion in
the <em>Delete Row</em> popup.</p>
<p>Use the <em>Security Labels</em> panel to define security labels applied to the view.
...
<p>Your entries in the <em>View</em> dialog generate a SQL command (see an example below).
...
the <em>View</em> dialog:</p>
<img alt="View dialog sql tab" class="align-center" src="_images/view_sql.png" />
<p>The example shown demonstrates creating a view named <em>distributor_codes</em> that
includes the content of the <em>code</em> column from the <em>distributors</em> table.</p>
<ul class="simple">
...
<li><p>Click the <em>Reset</em> button to restore configuration parameters.</p></li>
  ...
  <ul>
<li><a class="reference internal" href="#">View Dialog</a><ul>
