...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    <meta charset="utf-8" />
    <title>Version 4.10 &#8212; pgAdmin 4 4.11 documentation</title>
    ...
    <link rel="next" title="Version 4.9" href="release_notes_4_9.html" />
    <link rel="prev" title="Version 4.11" href="release_notes_4_11.html" /> 
  </head><body>
    <div class="related" role="navigation" aria-label="related navigation">
      ...
      <ul>
        ...
        <li class="right" >
          <a href="release_notes_4_9.html" title="Version 4.9"
  ...
  <div class="section" id="version-4-10">
<h1>Version 4.10<a class="headerlink" href="#version-4-10" title="Permalink to this headline">¶</a></h1>
<p>Release date: 2019-07-04</p>
<p>This release contains a number of bug fixes and new features since the release of pgAdmin4 4.9.</p>
<div class="section" id="new-features">
<h2>New features<a class="headerlink" href="#new-features" title="Permalink to this headline">¶</a></h2>
<div class="line-block">
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/4139">Issue #4139</a> -  Allow some objects to be dragged/dropped into the Query Tool to insert their signature into the query text.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/4400">Issue #4400</a> -  Allow the path to /pgadmin4/servers.json to be overridden in the container distribution.</div>
</div>
</div>
<div class="section" id="bug-fixes">
<h2>Bug fixes<a class="headerlink" href="#bug-fixes" title="Permalink to this headline">¶</a></h2>
<div class="line-block">
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/4403">Issue #4403</a> - Ensure the browser close confirmation is only shown when closing a Query Tool which is running in a separate browser tab.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/4404">Issue #4404</a> - Prevent an error that may occur when editing data with an integer primary key.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/4407">Issue #4407</a> - Fix a quoting issue that caused a blank UI to be displayed when running in French.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/4421">Issue #4421</a> - Ensure the version comparision should be correct for windows installer.</div>
</div>
</div>
</div>
  ...
  <ul>
<li><a class="reference internal" href="#">Version 4.10</a><ul>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">Version 4.10</a></li>
