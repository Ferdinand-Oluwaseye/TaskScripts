...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    <meta charset="utf-8" />
    <title>View/Edit Data &#8212; pgAdmin 4 4.11 documentation</title>
  ...
  <div class="section" id="view-edit-data">
<span id="editgrid"></span><h1><span class="target" id="index-0"></span>View/Edit Data<a class="headerlink" href="#view-edit-data" title="Permalink to this headline">¶</a></h1>
<p>To view or modify data, right click on a table or view name in the <em>Browser</em>
tree control.  When the context menu opens, use the <em>View/Edit Data</em> menu to
specify the number of rows you would like to display in the editor panel.</p>
...
<div class="section" id="the-view-edit-data-toolbar">
<h2>The View/Edit Data Toolbar<a class="headerlink" href="#the-view-edit-data-toolbar" title="Permalink to this headline">¶</a></h2>
...
<div class="section" id="the-data-grid">
<h2>The Data Grid<a class="headerlink" href="#the-data-grid" title="Permalink to this headline">¶</a></h2>
...
<p id="modifying-data-grid">To modify the displayed data:</p>
<ul class="simple">
...
<div class="section" id="sort-filter-options-dialog">
<h2>Sort/Filter options dialog<a class="headerlink" href="#sort-filter-options-dialog" title="Permalink to this headline">¶</a></h2>
