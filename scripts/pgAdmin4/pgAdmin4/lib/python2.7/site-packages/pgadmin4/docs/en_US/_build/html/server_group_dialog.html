...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    <meta charset="utf-8" />
    <title>Server Group Dialog &#8212; pgAdmin 4 4.11 documentation</title>
...
<p>Use the <em>Server Group</em> dialog to add a new server group. Assign servers to
server groups to simplify management of multiple servers. Server groups are
displayed as part of the <em>pgAdmin</em> tree control.</p>
<img alt="Server group dialog" class="align-center" src="_images/server_group.png" />
<p>Use the <em>Name</em> field on the <em>Server Group</em> dialog to specify a name that will
identify the server group in the <em>pgAdmin</em> tree control.</p>
<ul class="simple">
...
<p>To create server connections in a server group, right click on the named server
group and select the <em>Create</em> option to open the <em>Create - Server</em> dialog.</p>
</div>
