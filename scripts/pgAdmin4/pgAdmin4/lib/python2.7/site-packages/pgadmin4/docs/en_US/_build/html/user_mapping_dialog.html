...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    <meta charset="utf-8" />
    <title>User Mapping Dialog &#8212; pgAdmin 4 4.11 documentation</title>
...
<p>Use the <em>User Mapping</em> dialog to define a new mapping of a user to a foreign
server.</p>
<p>The <em>User Mapping</em> dialog organizes the development of a user mapping through
the following dialog tabs: <em>General</em> and <em>Options</em>. The <em>SQL</em> tab displays the
SQL code generated by dialog selections.</p>
<img alt="User Mapping dialog general tab" class="align-center" src="_images/user_mapping_general.png" />
<p>Use the drop-down listbox in the <em>User</em> field in the <em>General</em> tab to identify
the connecting role:</p>
<ul class="simple">
<li><p>Select <em>CURRENT_USER</em> to use the name of the current role.</p></li>
<li><p>Select <em>PUBLIC</em> if no other user-specific mapping is applicable.</p></li>
<li><p>Select a pre-defined role name to specify the name of an existing user.</p></li>
</ul>
<p>Click the <em>Options</em> tab to continue.</p>
<img alt="User Mapping dialog options tab" class="align-center" src="_images/user_mapping_options.png" />
<p>Use the fields in the <em>Options</em> tab to specify connection options; the accepted
option names and values are specific to the foreign data wrapper associated with
the server specified in the user mapping. Click the <em>Add</em> button to add an
option/value pair.</p>
<ul class="simple">
...
<p>Click <em>Add</em> to specify each additional option/value pair; to discard an option,
click the trash icon to the left of the row and confirm deletion in the <em>Delete
Row</em> popup.</p>
<p>Click the <em>SQL</em> tab to continue.</p>
<p>Your entries in the <em>User Mapping</em> dialog generate a SQL command (see an
...
the <em>User Mapping</em> dialog:</p>
<img alt="User Mapping dialog sql tab" class="align-center" src="_images/user_mapping_sql.png" />
<p>The example shown demonstrates a user mapping for the <em>hdfs_server</em>. The user is
<em>CURRENT_USER</em> with a password <em>secret</em>.</p>
<ul class="simple">
...
<li><p>Click the <em>Reset</em> button to restore configuration parameters.</p></li>
  ...
  <ul>
<li><a class="reference internal" href="#">User Mapping Dialog</a><ul>
