...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    <meta charset="utf-8" />
    <title>Exclusion Constraint Dialog &#8212; pgAdmin 4 4.11 documentation</title>
...
<em>exclude_department</em> that restricts additions to the dept table to those
additions that are not equal to the value of the <em>deptno</em> column.  The
constraint uses a btree index.</p>
<ul class="simple">
