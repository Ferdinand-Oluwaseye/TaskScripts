...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    <meta charset="utf-8" />
    <title>Procedure Dialog &#8212; pgAdmin 4 4.11 documentation</title>
...
dialog selections.</p>
<img alt="Procedure dialog general tab" class="align-center" src="_images/procedure_general.png" />
...
<img alt="Procedure dialog definition tab" class="align-center" src="_images/procedure_definition.png" />
...
<img alt="Procedure dialog options tab" class="align-center" src="_images/procedure_options.png" />
...
<img alt="Procedure dialog arguments tab" class="align-center" src="_images/procedure_arguments.png" />
<p>Use the fields in the <em>Arguments</em> tab to define an argument. Click <em>Add</em> to set
parameters and values for the argument:</p>
<ul class="simple">
...
<img alt="Procedure dialog parameters tab" class="align-center" src="_images/procedure_parameters.png" />
...
<img alt="Procedure dialog security tab" class="align-center" src="_images/procedure_security.png" />
...
<img alt="Procedure dialog sql tab" class="align-center" src="_images/procedure_sql.png" />
