...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    <meta charset="utf-8" />
    <title>FTS Configuration Dialog &#8212; pgAdmin 4 4.11 documentation</title>
...
<p>Use the <em>FTS Configuration</em> dialog to configure a full text search. A text
search configuration specifies a text search parser that can divide a string
into tokens, along with dictionaries that can identify searchable tokens.</p>
<p>The <em>FTS Configuration</em> dialog organizes the development of a FTS configuration
through the following dialog tabs: “<em>General</em>, <em>Definition</em>, and <em>Tokens</em>. The
<em>SQL</em> tab displays the SQL code generated by dialog selections.</p>
<p>Click the <em>General</em> tab to begin.</p>
<img alt="FTS configuration dialog general tab" class="align-center" src="_images/fts_configuration_general.png" />
<p>Use the fields in the <em>General</em> tab to identify a FTS configuration:</p>
<ul class="simple">
<li><p>Use the <em>Name</em> field to add a descriptive name for the FTS configuration. The
name will be displayed in the <em>pgAdmin</em> tree control.</p></li>
<li><p>Use the drop-down listbox next to <em>Owner</em> to specify the role that will own
the configuration.</p></li>
<li><p>Select the name of the schema in which the FTS configuration will reside from
the drop-down listbox in the <em>Schema</em> field.</p></li>
<li><p>Store notes about the FTS configuration in the <em>Comment</em> field.</p></li>
</ul>
<p>Click the <em>Definition</em> tab to continue.</p>
<img alt="FTS configuration dialog definition tab" class="align-center" src="_images/fts_configuration_definition.png" />
<p>Use the fields in the <em>Definition</em> tab to define parameters:</p>
<ul class="simple">
<li><p>Select the name of the text search parser from the drop-down listbox in the
<em>Parser</em> field.</p></li>
<li><p>Select a language from the drop-down listbox in the <em>Copy Config</em> field.</p></li>
</ul>
<p>Click the <em>Tokens</em> tab to continue.</p>
<img alt="FTS configuration dialog tokens tab" class="align-center" src="_images/fts_configuration_tokens.png" />
<p>Use the fields in the <em>Tokens</em> tab to add a token:</p>
<ul class="simple">
<li><p>Use the <em>Tokens</em> field to specify the name of a token.</p></li>
<li><p>Click the <em>Add</em> icon (+) to create a token.</p></li>
<li><p>Use the <em>Dictionaries</em> field to specify a dictionary.</p></li>
</ul>
<p>Repeat these steps to add additional tokens; to discard a token, click the
trash icon to the left of the row and confirm deletion in the <em>Delete Row</em>
popup.</p>
<p>Click the <em>SQL</em> tab to continue.</p>
<p>Your entries in the <em>FTS Configuration</em> dialog generate a SQL command (see an
...
the <em>FTS Configuration</em> dialog:</p>
<img alt="FTS configuration dialog sql tab" class="align-center" src="_images/fts_configuration_sql.png" />
<p>The example shown demonstrates creating a FTS configuration named
<em>meme_phrases</em>. It uses the <em>default</em> parser.</p>
<ul class="simple">
...
<li><p>Click the <em>Reset</em> button to restore configuration parameters.</p></li>
  ...
  <ul>
<li><a class="reference internal" href="#">FTS Configuration Dialog</a><ul>
