...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    <meta charset="utf-8" />
    <title>FTS Parser Dialog &#8212; pgAdmin 4 4.11 documentation</title>
...
<p>Use the <em>FTS Parser</em> dialog to create a new text search parser. A text search
parser defines a method for splitting a text string into tokens and assigning
types (categories) to the tokens.</p>
<p>The <em>FTS Parser</em> dialog organizes the development of a text search parser
...
<img alt="FTS parser dialog general tab" class="align-center" src="_images/fts_parser_general.png" />
<p>Use the fields in the <em>General</em> tab to identify a text search parser:</p>
<ul class="simple">
<li><p>Use the <em>Name</em> field to add a descriptive name for the parser. The name will
be displayed in the <em>pgAdmin</em> tree control.</p></li>
<li><p>Select the name of the schema in which the parser will reside from the
...
<img alt="FTS parser dialog definition tab" class="align-center" src="_images/fts_parser_definition.png" />
<p>Use the fields in the <em>Definition</em> tab to define parameters:</p>
<ul class="simple">
<li><p>Use the drop-down listbox next to <em>Start function</em> to select the name of the
function that will initialize the parser.</p></li>
<li><p>Use the drop-down listbox next to <em>Get next token function</em> to select the
name of the function that will return the next token.</p></li>
<li><p>Use the drop-down listbox next to <em>End function</em> to select the name of the
function that is called when the parser is finished.</p></li>
<li><p>Use the drop-down listbox next to <em>Lextypes function</em> to select the name of
...
parser.</p></li>
<li><p>Use the drop-down listbox next to <em>Headline function</em> to select the name of
the headline function for the parser. The headline function returns an excerpt
from the document in which the terms of the query are highlighted.</p></li>
</ul>
<p>Click the <em>SQL</em> tab to continue.</p>
<img alt="FTS parser dialog sql tab" class="align-center" src="_images/fts_parser_sql.png" />
<p>Your entries in the <em>FTS Parser</em> dialog generate a generate a SQL command. Use
the <em>SQL</em> tab for review; revisit or switch tabs to make any changes to the SQL
command.</p>
<ul class="simple">
