...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    <meta charset="utf-8" />
    <title>Add Named Restore Point Dialog &#8212; pgAdmin 4 4.11 documentation</title>
...
server’s postgresql.conf file must specify a <em>wal_level</em> value of <em>archive</em>,
<em>hot_standby</em>, or <em>logical</em>.  You must be a database superuser to create a
restore point.</p>
...
see the
<a class="reference external" href="https://www.postgresql.org/docs/current/recovery-target-settings.html#RECOVERY-TARGET-NAME">PostgreSQL documentation</a>.</p>
<ul class="simple">
