...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    <meta charset="utf-8" />
    <title>Foreign Data Wrapper Dialog &#8212; pgAdmin 4 4.11 documentation</title>
...
<ul class="simple">
<li><p>Click the the <em>Add</em> icon (+) button to add an option/value pair for the
...
<li><p>Select the name of the role granting the privileges from the drop-down listbox
in the <em>Grantor</em> field. The default grantor is the owner of the foreign data
wrapper.</p></li>
</ul>
...
<p>The example creates a foreign data wrapper named <em>libpq_debug</em> that uses
