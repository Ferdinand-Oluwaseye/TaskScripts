...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    <meta charset="utf-8" />
    <title>Event Trigger Dialog &#8212; pgAdmin 4 4.11 documentation</title>
...
<p>Use the <em>Domain Trigger</em> dialog to define an event trigger. Unlike regular
...
SQL.</p>
<p>The <em>Domain Trigger</em> dialog organizes the development of a event trigger through
...
<ul class="simple">
<li><p>Select a radio button in the <em>Enabled Status</em> field to specify a status for
the trigger: <em>Enable</em> <em>Disable</em>, <em>Replica</em> <em>Always</em>.</p></li>
...
<li><p>Select a radio button in the <em>Events</em> field to specify when the event trigger
will fire: <em>DDL COMMAND START</em>, <em>DDL COMMAND END</em>, or <em>SQL DROP</em>.</p></li>
<li><p>Use the <em>When</em> field to write a condition for the event trigger that must be
satisfied before the event trigger can execute.</p></li>
</ul>
...
<p>Your entries in the <em>Domain Trigger</em> dialog generate a generate a SQL command.
...
the <em>Domain Trigger</em> dialog:</p>
