...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    <meta charset="utf-8" />
    <title>Server Deployment &#8212; pgAdmin 4 4.11 documentation</title>
...
and may be created by administrators in the same directory as <code class="docutils literal notranslate"><span class="pre">config.py</span></code> if
needed.</p></li>
</ul>
...
<h3>Standalone Gunicorn Configuration<a class="headerlink" href="#standalone-gunicorn-configuration" title="Permalink to this headline">¶</a></h3>
...
<h3>Standalone uWSGI Configuration<a class="headerlink" href="#standalone-uwsgi-configuration" title="Permalink to this headline">¶</a></h3>
...
<h3>NGINX Configuration with Gunicorn<a class="headerlink" href="#nginx-configuration-with-gunicorn" title="Permalink to this headline">¶</a></h3>
...
<h3>NGINX Configuration with uWSGI<a class="headerlink" href="#nginx-configuration-with-uwsgi" title="Permalink to this headline">¶</a></h3>
