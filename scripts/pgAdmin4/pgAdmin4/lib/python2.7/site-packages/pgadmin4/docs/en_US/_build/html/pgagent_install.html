...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    <meta charset="utf-8" />
    <title>Installing pgAgent &#8212; pgAdmin 4 4.11 documentation</title>
...
<p>If you are using an earlier version of PostgreSQL or pgAgent, use the
<em>Open file</em> icon on the Query Tool toolbar to open a browser window and locate
the <em>pgagent.sql</em> script. The installation script is installed by pgAdmin, and
the installation location varies from operating system to operating system:</p>
<ul class="simple">
<li><p>On Windows, it is usually located under <em>C:\Program files\pgAdmin III</em> (or
<em>C:\Program files\PostgreSQL\8.x\pgAdmin III</em> if installed with the PostgreSQL
server installer).</p></li>
<li><p>On Linux, it is usually located under <em>/usr/local/pgadmin3/share/pgadmin3</em>
or <em>/usr/share/pgadmin3</em>.</p></li>
</ul>
<p>After loading the file into the Query Tool, click the <em>Execute</em> icon to execute
the script.  The script will create a number of tables and other objects in a
schema named <em>pgagent</em>.</p>
</div>
